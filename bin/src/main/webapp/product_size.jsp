...
$.ajax({
	...
	success:function(jsonResult){
		...
		for(var i=0; i<jsonResult.sizeList.length; i++){
			html += productSizeForm_p(jsonResult.sizeList[i], map[i]);
		}
		}else if(jsonResult.code == 2){
			for(var i=0; i<jsonResult.sizeList.length; i++){
				html += productSizeForm_s(jsonResult.sizeList[i], map[i]);
			}
		}
            ...
            <div class="col-lg-12">
               <div class="breadcrumb__text">
                  ...
                  <div class="breadcrumb__links">
                     <a href="main">Home</a> <a href="shop">Shop</a> <span id="top_text2">구매하기</span>
                  </div>
               </div>
            </div>
         </div>
   ...
   <div id="__nuxt">
      ...
      <div id="__layout">
         <div data-v-34b11929="" tabindex="0" class="wrap md etc" style="padding-top: 50px;">
            ...
            <!---->
            <div data-v-ed431aec="" data-v-34b11929="" class="container buy md">
               <div data-v-ed431aec="" class="content_area">
                  <div data-v-ed431aec="" class="buy_before">
                     <div data-v-ed431aec="" class="buy_before_check">
                        <div data-v-16a54f91="" data-v-ed431aec="" class="product_info" id="product_tag">
